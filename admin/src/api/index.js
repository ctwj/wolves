...
export const pluginNovelPreview = (id, payload) => usePost(`/plugin/novelPreview/${id}`, JSON.stringify(payload));
export const pluginNovelMerge = (id, payload) => usePost(`/plugin/novelMerge/${id}`, JSON.stringify(payload));
